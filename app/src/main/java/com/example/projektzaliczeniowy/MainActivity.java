...
public class MainActivity extends AppCompatActivity {
    ...
    public void OpenKalkulatorActivity(){
        Intent openKalk = new Intent(this, com.example.projektzaliczeniowy.Kalkulator.class);
        this.startActivity(openKalk);
    }
    public void OpenDaneActivity(){
        Intent openDane = new Intent(this, com.example.projektzaliczeniowy.Dane.class);
        this.startActivity(openDane);
    }
    public void OpenInfoActivity(){
        Intent openInfo = new Intent(this, com.example.projektzaliczeniowy.Info.class);
